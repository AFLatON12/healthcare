...
import { Container, Typography, Table, TableHead, TableRow, TableCell, TableBody, Button, CircularProgress, Alert, Box, Paper, Snackbar } from '@mui/material';
...
const DoctorDashboardNewV2 = ({ userPermissions = [] }) => {
  ...
  const renderContent = () => {
    switch (activeSection) {
      ...
      case 'profile':
        return <Typography variant="h6">Profile Section</Typography>;
      case 'schedule':
